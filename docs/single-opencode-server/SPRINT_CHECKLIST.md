...
- [ ] Inspect `/proc/<pid>/cmdline` when available.
- [ ] Confirm OpenCode serve command and port before signaling.
- [ ] Refuse to signal an unverifiable or reused PID.
...
- [ ] Recreate the local terminal when its process exits.
