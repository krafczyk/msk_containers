...
for dockerfile in "$x86" "$arm"; do
  ...
  assert_active "$dockerfile" 'ARG OPENCODE_VERSION=1.18.3-mkchad.2'
  assert_active "$dockerfile" 'ARG OPENCODE_REVISION=6ac414c7ee8f0b5ca4c98fddd1f3d43d4ab5c04a'
...
assert_contains "$adr" '`6ac414c7ee8f0b5ca4c98fddd1f3d43d4ab5c04a`'
assert_contains "$adr" '`1.18.3-mkchad.2`'
