...
for dockerfile in "$x86" "$arm"; do
  ...
  assert_active "$dockerfile" 'ARG OPENCODE_VERSION=1.18.3-mkchad.4'
  assert_active "$dockerfile" 'ARG OPENCODE_REVISION=223d942b977f5afcbbeeba72f869163daf01920f'
...
assert_contains "$adr" '`223d942b977f5afcbbeeba72f869163daf01920f`'
assert_contains "$adr" '`1.18.3-mkchad.4`'
