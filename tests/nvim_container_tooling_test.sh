...
for dockerfile in "$x86" "$arm"; do
  ...
  assert_active "$dockerfile" 'ARG OPENCODE_VERSION=1.18.3-mkchad.3'
  assert_active "$dockerfile" 'ARG OPENCODE_REVISION=5ef13270f81cb7ac7bfe11d6c444fdd8ca47467d'
...
assert_contains "$adr" '`5ef13270f81cb7ac7bfe11d6c444fdd8ca47467d`'
assert_contains "$adr" '`1.18.3-mkchad.3`'
